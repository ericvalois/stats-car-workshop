...
const proxy = `https://cors-anywhere.herokuapp.com/`; //const form = document.querySelector('form.search');
...
promiseTitle.then(successCallback, failureCallback); // Total neuf

let promiseR41C1 = getContent('R41C1');
promiseR41C1.then(successCallback, failureCallback); // Total brut

let promiseR41C3 = getContent('R41C3');
promiseR41C3.then(successCallback, failureCallback); // Moyenne Front

let promiseR47C1 = getContent('R47C1');
promiseR47C1.then(successCallback, failureCallback); // Moyenne F&I

let promiseR47C3 = getContent('R47C3');
promiseR47C3.then(successCallback, failureCallback); // Henry

let promiseR53C3 = getContent('R53C3');
promiseR53C3.then(successCallback, failureCallback); // Karine

let promiseR53C5 = getContent('R53C5');
promiseR53C5.then(successCallback, failureCallback); // Moyenne Total
